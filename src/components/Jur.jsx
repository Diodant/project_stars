...
function Jur() {
  ...
  return (
    ...
    <div className='wrapper'>
    <div className='text mb-50'>Жюри нашего Международного конкурса beauty мастеров "Звезды красоты" состоит из ведущих международных профессионалов индустрии красоты, каждый из которых имеет не менее трех лет опыта в своей специализации. Эти эксперты были отобраны на основе их профессиональных достижений, глубоких знаний и выдающегося вклада в развитие сферы красоты.</div>
    ...
    <div className='text mb-50'>Судейство на <b>Международном конкурсе beauty мастеров</b> "Звезды красоты" предоставляет уникальную возможность для профессионального роста и обмена знаниями с коллегами и новым поколением специалистов, поддерживая и развивая высокие стандарты и креативность в индустрии.</div>
    <p className='sub-title'>Критерии для отбора судей международного конкурса beauty мастеров “Звезды красоты”:</p>
      ...
      <div>
        ...
        {selectedYearData2 && (
          <div className='mb-100'>
            <h2 className='winners-title'>Жюри: {year}</h2>
            <div className='winners-title'>Перманентный макияж, визаж, а также Lash и Brow направление</div>
            <div className="jury-con">
